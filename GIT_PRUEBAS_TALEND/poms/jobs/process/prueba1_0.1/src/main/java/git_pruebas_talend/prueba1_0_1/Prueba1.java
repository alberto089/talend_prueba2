...
public class Prueba1 implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Prueba1.log");
	}
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Prueba1.class.getClassLoader()
					.getResourceAsStream("git_pruebas_talend/prueba1_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Prueba1.class.getClassLoader()
...
/************************************************************************************************
 * 43686 characters generated by Talend Cloud Big Data on the 5 de diciembre de
 * 2019 16:43:46 CET
 ************************************************************************************************/