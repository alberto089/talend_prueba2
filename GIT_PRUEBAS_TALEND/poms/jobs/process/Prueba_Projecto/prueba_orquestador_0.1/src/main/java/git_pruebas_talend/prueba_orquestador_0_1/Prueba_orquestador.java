...
package git_pruebas_talend.prueba_orquestador_0_1;
...
/**
 * Job: Prueba_orquestador Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Prueba_orquestador implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Prueba_orquestador.log");
	}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(Prueba_orquestador.class);
	...
	private final String jobName = "Prueba_orquestador";
	private final String projectName = "GIT_PRUEBAS_TALEND";
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_IrxjIBd3EeqbvK0QsNo1Eg", "0.1");
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Prueba_orquestador.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Prueba_orquestador.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tRunJob_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tRunJob_1.append("PROCESS" + " = " + "Prueba1");
							log4jParamters_tRunJob_1.append(" | ");
				...
				git_pruebas_talend.prueba1_0_1.Prueba1 childJob_tRunJob_1 = new git_pruebas_talend.prueba1_0_1.Prueba1();
				// pass DataSources
				...
				log.info(
						"tRunJob_1 - The child job 'git_pruebas_talend.prueba1_0_1.Prueba1' starts on the version '0.1' with the context 'Default'.");

				String[][] childReturn_tRunJob_1 = childJob_tRunJob_1
						.runJob((String[]) paraList_tRunJob_1.toArray(new String[paraList_tRunJob_1.size()]));

				log.info("tRunJob_1 - The child job 'git_pruebas_talend.prueba1_0_1.Prueba1' is done.");
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tRunJob_3 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tRunJob_3.append("PROCESS" + " = " + "Prueba4");
							log4jParamters_tRunJob_3.append(" | ");
				...
				git_pruebas_talend.prueba4_0_1.Prueba4 childJob_tRunJob_3 = new git_pruebas_talend.prueba4_0_1.Prueba4();
				// pass DataSources
				...
				log.info(
						"tRunJob_3 - The child job 'git_pruebas_talend.prueba4_0_1.Prueba4' starts on the version '0.1' with the context 'Default'.");
				...
				log.info("tRunJob_3 - The child job 'git_pruebas_talend.prueba4_0_1.Prueba4' is done.");
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tRunJob_6 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tRunJob_6.append("PROCESS" + " = " + "Prueba5");
							log4jParamters_tRunJob_6.append(" | ");
				...
				git_pruebas_talend.prueba5_0_1.Prueba5 childJob_tRunJob_6 = new git_pruebas_talend.prueba5_0_1.Prueba5();
				// pass DataSources
				...
				log.info(
						"tRunJob_6 - The child job 'git_pruebas_talend.prueba5_0_1.Prueba5' starts on the version '0.1' with the context 'Default'.");
				...
				log.info("tRunJob_6 - The child job 'git_pruebas_talend.prueba5_0_1.Prueba5' is done.");
	...
	public static void main(String[] args) {
		final Prueba_orquestador Prueba_orquestadorClass = new Prueba_orquestador();

		int exitCode = Prueba_orquestadorClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Prueba_orquestador' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'Prueba_orquestador' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = Prueba_orquestador.class.getClassLoader().getResourceAsStream(
					"git_pruebas_talend/prueba_orquestador_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Prueba_orquestador.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Prueba_orquestador");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 58134 characters generated by Talend Cloud Big Data on the 5 de diciembre de
 * 2019 17:05:37 CET
 ************************************************************************************************/