...
package git_pruebas_talend.prueba5_0_1;
...
/**
 * Job: Prueba5 Purpose: <br>
 * Description:  <br>
 * @author alberto.vadillo.munoz@devoteam.com
 * @version 7.2.1.20190909_1200_patch
 * @status 
 */
public class Prueba5 implements TalendJob {
	static {System.setProperty("TalendJob.log", "Prueba5.log");}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(Prueba5.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Prueba5";
...
private RunStat runStat = new RunStat();
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_dJXAcBddEeqQo8SlaQ9gOg", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Prueba5.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_GIT_PRUEBAS_TALEND_Prueba5 = new byte[0];
    static byte[] commonByteArray_GIT_PRUEBAS_TALEND_Prueba5 = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_GIT_PRUEBAS_TALEND_Prueba5) {
 ...
 */
    ...
    public static void main(String[] args){
        final Prueba5 Prueba5Class = new Prueba5();

        int exitCode = Prueba5Class.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Prueba5' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        for (String arg : args) {
        	...
        	log.info("TalendJob: 'Prueba5' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = Prueba5.class.getClassLoader().getResourceAsStream("git_pruebas_talend/prueba5_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Prueba5.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Prueba5");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     43686 characters generated by Talend Cloud Big Data 
 *     on the 5 de diciembre de 2019 17:05:36 CET
 ************************************************************************************************/