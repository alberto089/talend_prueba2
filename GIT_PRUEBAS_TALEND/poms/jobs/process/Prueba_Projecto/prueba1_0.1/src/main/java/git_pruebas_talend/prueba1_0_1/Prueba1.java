...
package git_pruebas_talend.prueba1_0_1;
...
/**
 * Job: Prueba1 Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 7.2.1.20190909_1200_patch
 * @status 
 */
public class Prueba1 implements TalendJob {
	static {System.setProperty("TalendJob.log", "Prueba1.log");}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(Prueba1.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Prueba1";
...
private RunStat runStat = new RunStat();
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_7wB64Bd1EeqbvK0QsNo1Eg", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Prueba1.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_GIT_PRUEBAS_TALEND_Prueba1 = new byte[0];
    static byte[] commonByteArray_GIT_PRUEBAS_TALEND_Prueba1 = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_GIT_PRUEBAS_TALEND_Prueba1) {
 ...
 */
    ...
    public static void main(String[] args){
        final Prueba1 Prueba1Class = new Prueba1();

        int exitCode = Prueba1Class.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Prueba1' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        for (String arg : args) {
        	...
        	log.info("TalendJob: 'Prueba1' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = Prueba1.class.getClassLoader().getResourceAsStream("git_pruebas_talend/prueba1_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Prueba1.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Prueba1");
        }
		if(enableLogStash) {
 ...
 *     on the 5 de diciembre de 2019 17:05:34 CET
 ************************************************************************************************/