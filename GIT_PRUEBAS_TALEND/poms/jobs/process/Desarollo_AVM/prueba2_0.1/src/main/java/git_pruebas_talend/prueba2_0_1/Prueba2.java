...
package git_pruebas_talend.prueba2_0_1;
...
public class Prueba2 implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Prueba2.log");
	}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_GIT_PRUEBAS_TALEND_Prueba2 = new byte[0];
		static byte[] commonByteArray_GIT_PRUEBAS_TALEND_Prueba2 = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_GIT_PRUEBAS_TALEND_Prueba2) {
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Prueba2.class.getClassLoader()
					.getResourceAsStream("git_pruebas_talend/prueba2_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Prueba2.class.getClassLoader()
