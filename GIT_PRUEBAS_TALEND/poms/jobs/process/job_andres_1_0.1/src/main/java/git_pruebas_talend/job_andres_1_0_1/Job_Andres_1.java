...
package git_pruebas_talend.job_andres_1_0_1;
...
/**
 * Job: Job_Andres_1 Purpose: Job_Andres_1<br>
 * Description: Job_Andres_1 <br>
 * 
 * @author andres.torres.mendoza@devoteam.com
 * @version 7.2.1.20190909_1200_patch
 * @status
 */
public class Job_Andres_1 implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Job_Andres_1.log");
	}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(Job_Andres_1.class);
	...
	private final String jobName = "Job_Andres_1";
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_AZAe4Bd7Eequp66Al8M4Xw", "0.1");
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Job_Andres_1.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_GIT_PRUEBAS_TALEND_Job_Andres_1 = new byte[0];
		static byte[] commonByteArray_GIT_PRUEBAS_TALEND_Job_Andres_1 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_GIT_PRUEBAS_TALEND_Job_Andres_1.length) {
					if (length < 1024 && commonByteArray_GIT_PRUEBAS_TALEND_Job_Andres_1.length == 0) {
						commonByteArray_GIT_PRUEBAS_TALEND_Job_Andres_1 = new byte[1024];
					} else {
						commonByteArray_GIT_PRUEBAS_TALEND_Job_Andres_1 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_GIT_PRUEBAS_TALEND_Job_Andres_1, 0, length);
				strReturn = new String(commonByteArray_GIT_PRUEBAS_TALEND_Job_Andres_1, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_GIT_PRUEBAS_TALEND_Job_Andres_1) {
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final Job_Andres_1 Job_Andres_1Class = new Job_Andres_1();

		int exitCode = Job_Andres_1Class.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Job_Andres_1' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'Job_Andres_1' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = Job_Andres_1.class.getClassLoader()
					.getResourceAsStream("git_pruebas_talend/job_andres_1_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Job_Andres_1.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Job_Andres_1");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 44368 characters generated by Talend Cloud Big Data on the 5 de diciembre de
 * 2019 17:26:45 CET
 ************************************************************************************************/